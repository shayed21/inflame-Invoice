...
const Index = () => {
  ...
  useEffect(() => {
    ...
    if (savedFormData) {
      ...
      setSelectedCurrency(parsedData.selectedCurrency || "BDT"); // Load selectedCurrency from localStorage
    } else {
      ...
      <div className="container mx-auto px-4 py-8 relative">
        ...
        <div className="fixed top-4 left-4 flex gap-2">
          ...
          <button
            ...
            className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white p-3 rounded-full shadow-lg hover:from-emerald-600 hover:to-emerald-700 transition-all duration-200 transform hover:scale-105"
        ...
        <button
          ...
          className="fixed top-4 right-4 bg-gradient-to-r from-teal-500 to-teal-600 text-white p-3 rounded-full shadow-lg hover:from-teal-600 hover:to-teal-700 transition-all duration-200 transform hover:scale-105"
        ...
        <div className="flex flex-col md:flex-row gap-8">
            ...
            <form>
              ...
              <div className="mb-6">
                <div className="flex items-center mb-2">
                  <h3 className="text-lg font-medium text-slate-800">Notes</h3>
                  <button
                    type="button"
          ...
          <div className="w-full md:w-1/2 bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-slate-200/50">
            <h2 className="text-2xl font-semibold mb-4 text-slate-800">Template Gallery</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {templates.map((template, index) => (
                <div
                  key={index}
                  className="template-card bg-gradient-to-b from-slate-50 to-slate-100 p-4 rounded-lg cursor-pointer hover:shadow-xl transition-all duration-300 transform hover:scale-105 border border-slate-200 hover:border-emerald-300"
