    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-emerald-50">
      <div className="container mx-auto px-4 py-8 relative">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-4">
            <Button
              ...
              className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white px-6 py-2 rounded-lg shadow-lg transition-all duration-200 transform hover:scale-105"
            >
              {isDownloading ? (
                <>
            ...
            <button
              onClick={() => navigate("/")}
              className="bg-gradient-to-r from-teal-500 to-teal-600 text-white p-3 rounded-full shadow-lg hover:from-teal-600 hover:to-teal-700 transition-all duration-200 transform hover:scale-105"
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="w-full md:w-1/2 bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-slate-200/50">
            <form>
              <div className="mb-6">
                <h2 className="text-2xl font-semibold mb-4 text-slate-800">Your Company</h2>
              ...
              <div className="mb-6 bg-gradient-to-r from-emerald-50 to-teal-50 p-4 rounded-lg border border-emerald-200">
                <h3 className="text-lg font-medium mb-3 text-slate-800">Totals</h3>
                ...
                <div className="flex justify-between mb-2 items-center">
                  ...
                  <input
                    ...
                    className="w-24 p-2 border border-emerald-300 rounded-md focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all"
                    min="0"
                    max="28"
                    step="1"
                  />
                ...
                <div className="flex justify-between font-bold text-lg text-emerald-700 border-t border-emerald-300 pt-2">
              ...
              <div className="mb-6">
                <h3 className="text-lg font-medium mb-2 text-slate-800">Notes</h3>
                <textarea
                  value={notes}
                  onChange={(e) => setNotes(e.target.value)}
                  className="w-full p-3 border border-slate-300 rounded-lg focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all"
                  rows="4"
                ></textarea>
              </div>
              <div className="mb-6">
                <div className="flex items-center mb-2">
                  <h3 className="text-lg font-medium text-slate-800">Footer</h3>
                  <button
                    type="button"
                    onClick={refreshFooter}
                    className="ml-2 p-1 rounded-full hover:bg-emerald-100 text-emerald-600 transition-colors"
          ...
          <div className="w-full md:w-1/2 bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-slate-200/50">
            <h2 className="text-2xl font-semibold mb-4 text-slate-800">Receipt Preview</h2>
            <div className="mb-4 flex items-center">
              <h3 className="text-lg font-medium mr-4 text-slate-700">Receipt Type</h3>
              <div className="flex gap-4">
                <label className="flex items-center">
                  ...
                  />
                  <span className="text-slate-700">Receipt1</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="radio"
                    ...
                    className="mr-2 text-emerald-500 focus:ring-emerald-500"
                  />
                  <span className="text-slate-700">Receipt2</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="radio"
                    ...
                    className="mr-2 text-emerald-500 focus:ring-emerald-500"
                  />
                  <span className="text-slate-700">Receipt3</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="radio"
                    ...
                    className="mr-2 text-emerald-500 focus:ring-emerald-500"
                  />
                  <span className="text-slate-700">Receipt4</span>
                </label>
              </div>
            </div>
            <div ref={receiptRef} className="w-[380px] mx-auto border border-slate-300 shadow-xl rounded-lg overflow-hidden">
              {theme === "Receipt1" && (
                <Receipt1
                  data={{
                    billTo,
